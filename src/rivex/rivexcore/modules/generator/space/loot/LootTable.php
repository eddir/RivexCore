...
namespace rivex\rivexcore\modules\generator\space\loot;
...
class LootTable
{
        ...
        if ($cfg->exists($pos->x . ";" . $pos->y . ";" . $pos->z)) {
            ...
            foreach ($loots as $loot) {
                ...
                for ($i = 0; $i <= $randCount; $i++) {
                    ...
                    if (isset($loot["tags"])) $items[$rand]->setCompoundTag(JsonNbtParser::parseJSON($loot["tags"]));
                }
            }
    ...
    {
        return getcwd() . DIRECTORY_SEPARATOR . "plugins" . DIRECTORY_SEPARATOR . "RivexCore" . DIRECTORY_SEPARATOR;
    }
