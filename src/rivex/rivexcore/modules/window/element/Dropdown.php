...
class Dropdown extends Element
{
    ...
    public function getSelectedOption(): string
    {
        $index = $this->getValue();
        if ($index === null) {
            throw new \InvalidArgumentException("No option selected (form closed or hasn't been submitted yet)");
        }
        ...
        throw new \InvalidArgumentException("No option found at index $index");
    }

    public function handle($value, Player $player)
    {
        return array('index' => $value, $this->options[$value]);
    }
